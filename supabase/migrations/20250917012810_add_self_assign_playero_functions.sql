-- =====================================================
-- MIGRACIÓN: FUNCIONES PARA AUTO-ASIGNACIÓN DE PLAYERO
-- =====================================================
-- Implementa funciones para que un dueño se asigne como playero de sus propias playas

-- 1. Función para verificar si un dueño ya es playero de alguna de sus playas
...
AS $$
BEGIN
    -- Verificar si el dueño ya está asignado como playero en alguna de sus playas
    RETURN EXISTS (
        SELECT 1 
...
-- 2. Función para auto-asignar un dueño como playero de sus playas seleccionadas
...
BEGIN
    ...
    IF NOT v_ya_tenia_rol THEN
        INSERT INTO public.rol_usuario (usuario_id, rol, fecha_asignacion)
        VALUES (p_dueno_id, 'PLAYERO', now())
...
COMMENT ON FUNCTION public.verificar_dueno_es_playero(uuid) IS 'Verifica si un dueño ya está asignado como playero en alguna de sus propias playas';
COMMENT ON FUNCTION public.auto_asignar_dueno_como_playero(uuid[], uuid) IS 'Permite a un dueño auto-asignarse como playero de sus propias playas seleccionadas';
