...
BEGIN
    ...
    INSERT INTO public.playero_invitacion (
        ...
        p_email,
        COALESCE(p_nombre, v_usuario_nombre, 'Usuario'),
        p_dueno_id,
        p_playas_ids,
        'PENDIENTE',
        now(),
...
COMMENT ON FUNCTION public.crear_invitacion_playero IS 'Crea invitación para playero, detecta automáticamente si el usuario existe';
GRANT EXECUTE ON FUNCTION public.crear_invitacion_playero TO authenticated;
