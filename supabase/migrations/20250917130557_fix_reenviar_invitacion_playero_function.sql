-- =====================================================
-- MIGRACIÓN: CORREGIR FUNCIÓN REENVIAR_INVITACION_PLAYERO
-- =====================================================
-- Corrige la función reenviar_invitacion_playero eliminando la referencia a fecha_creacion
...
COMMENT ON FUNCTION public.reenviar_invitacion_playero(text, uuid) IS 'Reenvía una invitación creando una nueva entrada y marcando la anterior como expirada para resetear completamente el proceso.';
