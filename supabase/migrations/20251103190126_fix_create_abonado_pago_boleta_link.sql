...
COMMENT ON FUNCTION public.create_abonado_with_abono IS 
  'Crea o actualiza un abonado y genera un abono con vehículos, primera boleta pagada y registro de pago vinculado a la boleta. Requiere turno activo y valida que la plaza esté disponible.';
