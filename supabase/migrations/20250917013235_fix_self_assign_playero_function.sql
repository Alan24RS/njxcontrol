-- =====================================================
-- MIGRACIÓN: CORREGIR FUNCIÓN DE AUTO-ASIGNACIÓN
-- =====================================================
-- Corrige la función auto_asignar_dueno_como_playero para usar las columnas correctas

-- Función corregida para auto-asignar un dueño como playero de sus playas seleccionadas
...
BEGIN
    ...
    -- Asignar rol PLAYERO si no lo tiene (solo usuario_id y rol)
...
COMMENT ON FUNCTION public.auto_asignar_dueno_como_playero(uuid[], uuid) IS 'Permite a un dueño auto-asignarse como playero de sus propias playas seleccionadas. Corregida para usar solo las columnas existentes en rol_usuario (usuario_id, rol)';
