-- Función final corregida para actualizar un tipo de plaza con sus características
...
BEGIN
  ...
  -- Validar que todas las características existen si se proporcionan
  ...
  WHERE tipo_plaza_caracteristica.playa_id = v_playa_id 
    AND tipo_plaza_caracteristica.tipo_plaza_id = p_tipo_plaza_id;
